...
import { changeVotePost, deletePost } from '../../common/api.common';
import { fetchAllPosts, fetchPostComments } from '../../common/actions.common';
import PostEdit from './edit/post.edit.container';
...
class Post extends Component {
    ...
    changeVote = voteType => {
        changeVotePost(this.getPostId(), voteType).then(() => {
    ...
    closeDeletePostModal = state => {
        ...
        if (state) {
            deletePost(this.props.data.id).then(() => {
                this.props.dispatch(fetchAllPosts());
            });
        }
    };
        ...
        return (
            ...
            >
                ...
                <div className="card-body">
                        ...
                        <div className="col-2">
                            {this.props.showControls && (
                                <div>
                                    ...
                                    <PostEdit postData={this.props.data} />
                                </div>
                            )}
                        </div>
                    </div>
                    ...
                    <h5>
                        <b>score:</b> {this.props.data.voteScore}
                    </h5>
                    <h5>
                        <b>comments:</b> {this.props.data.commentCount}
                    </h5>
                    <h5>
